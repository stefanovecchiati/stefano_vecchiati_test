...
public enum DiffList {
    ...
    public struct Result {
        ...
        public var hasChanges: Bool {
            return !self.inserts.isEmpty || !self.deletes.isEmpty || !self.updates.isEmpty || !self.moves.isEmpty
        }
    ...
    public static func diffing<T: Diffable & Equatable>(oldArray: [T], newArray: [T]) -> Result {
